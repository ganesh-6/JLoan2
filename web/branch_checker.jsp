...
<html lang="en">
    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="nav nav-pills">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#tab4" data-bs-toggle="tab"><i class="nav-icon fa-solid fa-pen-to-square"></i>Branch Maker</a></li>
                        <li class="nav-item"><a class="nav-link active" href="#tab5" data-bs-toggle="tab"><i class="nav-icon fa-solid fa-list-check"></i>Branch Checker</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <div class="mt-4">
            ...
            <!-- TAB 4- Branch Maker -->
            <div class="tab-pane fade m-4 mt-2" id="tab4" role="tabpanel" aria-labelledby="tab4-tab">
                        ...
                        <div class="accordion" id="accordionExample2">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="h41">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#c41" aria-expanded="true" aria-controls="c41">Previous Loan Details</button>
                                </h2>
                                <div id="c41" class="accordion-collapse collapse show" aria-labelledby="h41" data-bs-parent="#accordionExample2">
                                    <div class="accordion-body">
                                        <form class="row">
                                            <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-2">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="h42">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#c42" aria-expanded="false" aria-controls="c42">Facility Detail</button>
                                </h2>
                                <div id="c42" class="accordion-collapse collapse" aria-labelledby="h42" data-bs-parent="#accordionExample2">
                                    <div class="accordion-body">
                                        <form class="row">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="h43">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#c43" aria-expanded="false" aria-controls="c43">Div 3</button>
                                </h2>
                                <div id="c43" class="accordion-collapse collapse" aria-labelledby="h43" data-bs-parent="#accordionExample2">
                                    <div class="accordion-body">
                                        <form class="row">
                                            <h6 class=" sub-tab-heading mt-2 mb-4">Content of div 3</h6>
                            ...
                            <!--Accordian 4-->
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="h44">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#c44" aria-expanded="false" aria-controls="c44">Div 4</button>
                                </h2>
                                <div id="c44" class="accordion-collapse collapse" aria-labelledby="h44" data-bs-parent="#accordionExample2">
                                    <div class="accordion-body">
                                        <form class="row">
                                            <h6 class=" sub-tab-heading mt-2 mb-4">Content of div 4</h6>
                            ...
                            <!--Accordian 5-->
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="h45">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#c45" aria-expanded="false" aria-controls="c45">Div 5</button>
                                </h2>
                                <div id="c45" class="accordion-collapse collapse" aria-labelledby="h45" data-bs-parent="#accordionExample2">
                                    <div class="accordion-body">
                                        <form class="row">
                                            <h6 class=" sub-tab-heading mt-2 mb-4">Content of div 5</h6>
            ...
            <!-- TAB 5- Branch Checker -->
            <div class="tab-pane fade show active mt-2" id="tab5" role="tabpanel" aria-labelledby="tab5-tab">
                <form class="row tab-content" onsubmit="event.preventDefault(); window.location.href = './branch_checker.jsp'">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-2">
                        <label for="name1" class="form-label">GL No. Of Accounts</label>
                        <input type="text" class="form-control" id="name1" name="name1">
                    </div>
                    ...
                    <div class="col-md-12 mb-2">
                        <button type="button" class="btn btn-primary mt-3" style="float:right;" >SUBMIT</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <script>
            ...
            // Disable all fields of Data Clean
            ...
            // Disable all fields of Branch Maker
            $('#tab4 :input[type="text"]').attr('disabled', true).css("cursor", "not-allowed");
            $('#tab4 :input[type="date"]').attr('disabled', true).css("cursor", "not-allowed");
            $('#tab4').find("select, .input-btn").attr('disabled', true).css("cursor", "not-allowed");
        </script>
    </body>
</html>