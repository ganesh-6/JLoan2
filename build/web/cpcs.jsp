    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="nav nav-pills">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="#tab2" data-bs-toggle="tab"><i class="nav-icon fa-solid fa-server"></i>CPCS Detail</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <div class="mt-4">
            ...
            <div class="tab-pane fade show active mb-5" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                <form onsubmit="event.preventDefault(); window.location.href = './branch_maker.jsp'" class="row tab-content">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-2">
